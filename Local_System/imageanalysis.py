...
directory = wb.sheets[0].range('I11').value
wb.sheets[0].range('G20').value = "Successfully retrieved image folder path, Now I am processing Image Analysis Request..."
...
def run_local():
    ...
    for roots,dir,filenames in os.walk(directory):
        for file in filenames:
            ...
            wb.sheets[0].range('G20').value = file+" analyzed"

    wb.sheets[0].range('G20').value = "I am processed your images..."
    ...
    writer.save()
    wb.sheets[0].range('G20').value = "Downloaded Analyzed file Successfully in Download/Image Analytics folder"